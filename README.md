...
## Two sample t-test
![Two Sample t-test](https://github.com/TingsterX/power__reliability_sample_size/blob/master/Figures/Rplot_line_2sample_t_test.png "Field Map - Two sample t-test"){:height="12px" width="24px"}
## Paired t-test
